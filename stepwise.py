...
class grammar:
	...
	def setRules(self, **args):
		if len(args) is 2:
			self.A1R1, self.A2R1, self.A3R1, self.A4R1, self.A5R1, self.A6R1, self.A7R1 = args[0]
			self.A1R2, self.A2R2, self.A3R2, self.A4R2, self.A5R2, self.A6R2, self.A7R2 = args[1]
		if len(args) is 14:
			self.A1R1 = args[0]
			self.A1R2 = args[1]
			self.A2R1 = args[2]
