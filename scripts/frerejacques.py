...
frerejacques_transposed = [Note(x, 4, y + 7) for x, y in zip(durs, pitches)]
frerejacques_delayed = [Rest(4) for x in range(4)] + frerejacques
frerejacques_delayed_transposed = [Rest(4) for x in range(4)] + frerejacques_transposed
...
frerejacques_delayed2 = frerejacques_delayed_transposed + frerejacques
