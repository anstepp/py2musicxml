...
list_one = fractal_names(1, rachel_pitches, aaron_pitches, 0, 0)
list_two = fractal_names(1, morgan_pitches, john_pitches, 0, 1)
list_three = fractal_names(1, aaron_pitches, morgan_pitches, 2, 2)
list_four = fractal_names(1, morgan_pitches, rachel_pitches, 1, 3)
...
parts = [instrument.note_list for instrument in instruments]
